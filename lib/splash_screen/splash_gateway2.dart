              ...
              child: Align(
                ...
                child: Column(
                  children: [
                    ...
                    Text('Welcome to Tamshyah', style: TextStyle(color: Colors.white, fontSize: 26.sp),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text('Continue as guest', style: TextStyle(color: Colors.white, fontSize: 14.sp, fontWeight: FontWeight.bold)),
                        SizedBox(width: 5.w,),
                        GestureDetector(
                          onTap: () {
                            log('Icon clicked==============>');
