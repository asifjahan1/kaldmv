    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildField(controller.phone1Controller, 'Your phone number'),

          _buildLabel('Phone Number-2 (optional)'),
          _buildField(controller.phone2Controller, 'Your phone number'),

          _buildLabel('Website (optional)'),
          _buildField(controller.websiteController, 'Your Website URL'),
        ],
      ),
    );
  }
