          ...
          child: Column(
            children: [
              ...
              Obx(() => CustomHeader(
                  ...
                  isAISuggestionPanelVisible: controller.showAISuggestionPanel.value,
              ),
              ),
              ...
              Obx(() {
                return controller.showAISuggestionPanel.value
                  ...
                  onPressed: () {
                    controller.showAISuggestionPanel.value = !controller.showAISuggestionPanel.value;
                  },
                );
              }),
              // AI Suggestion Panel
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    Expanded(
                      child: DropdownButtonFormField<String>(
                        ...
                        items: controller.durationTimes.map((String time) {
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: controller.budgetRanges.map((String budget) {
                    return DropdownMenuItem<String>(
                      value: budget,
                      child: Text(budget),
                    );
                ...
                CustomTextField(
                  ...
                  onTap: () async {
                    ...
                    if (result != null && result.files.single.path != null) {
                      controller.filePathController.text = result.files.single.name;
                      // Optional: save full path too if needed
                      // final filePath = result.files.single.path!;
                    }
                  },
                  textEditingController: controller.filePathController,
                ...
                CustomTextField(
                  ...
                  textColor: Colors.black,
                  hintTextColor: Colors.grey[500],
                  hintText: 'Special Requirements (e.g., vegetarian food options, wheelchair accessible places)',
                  textEditingController: controller.specialRequirementController,
                  borderSide: const BorderSide(color: Color(0xFF867B79)),
                  fontSize: 13.sp,
                  maxLines: 5,
                  fontWeight: FontWeight.w400,
                ...
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return Obx(() => GestureDetector(
                      onTap: () => controller.setCategory(controller.categories[index].name),
                      child: Container(
                        height: 100.h,
                        width: 100.w,
                        padding: EdgeInsets.all(10.w),
                        decoration: BoxDecoration(
                          color: controller.selectedCategory.value == controller.categories[index].name
                                  ...
                                  children: [
                                    ...
                                    Positioned(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            controller.popularCountries[index].name,
                                            style: TextStyle(
                                              fontSize: 14.sp,
                                              fontWeight: FontWeight.bold,
                                              color: Colors.white,
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () {},
                      child: const Text('See all', style: TextStyle(color: Color(0xFFF97C68))),
                    ),
                  ],
                ),
              ),
