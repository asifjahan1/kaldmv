                      ...
                      children: [
                        GestureDetector(
                          ...
                          child: Image.asset(
                            ...
                            height: 28.h,
                            width: 28.w,
                            color: controller.isGridView.value ? Colors.black : Color(0xFFF97C68),
                          ),
                        ),
                        SizedBox(width: 5.w),
                        GestureDetector(
                          ...
                          child: Image.asset(
                            ...
                            height: 26.h,
                            width: 26.w,
                            color: controller.isGridView.value ? Color(0xFFF97C68) : Colors.black,
                          ),
                        ),
                      ],
                    )
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Obx(() => CustomButton(
                      ...
                      fontSize: 14.sp,
                      borderRadius: 16.r,
                      borderSide: BorderSide(color: Color(0xFFC3C0C0).withAlpha(100)),
                              ...
                              Stack(
                                children: [
                                  ...
                                  Positioned(
                                    ...
                                    child: CircleAvatar(
                                      radius: 14.r,
                                      child: Icon(Icons.save, color: Colors.white, size: 16.sp),
                                    ),
                                  ),
                                ],
                              ),
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Expanded(
                                            child: Text(
                                              _truncateToThreeWords(item.location),
                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              ...
                                              SizedBox(width: 4.w),
                                              Icon(Icons.star, size: 12.sp, color: Colors.yellow[700]),
                                            ],
                                          ),
                                          Text('Free',
                                              style: TextStyle(
                              ...
                              Stack(
                                children: [
                                  ...
                                  Positioned(
                                    ...
                                    right: 8.w,
                                    child: CircleAvatar(
                                      child: Icon(Icons.save, color: Colors.white, size: 26.sp),
                                    ),
                                  ),
                                ],
                              ),
